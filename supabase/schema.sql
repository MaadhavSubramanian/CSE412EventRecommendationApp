...
CREATE OR REPLACE FUNCTION "public"."event_ids_within_radius"("center_lat" double precision, "center_lon" double precision, "radius_miles" double precision) RETURNS TABLE("event_id" bigint)
    LANGUAGE "sql"
    AS $$
  SELECT e.event_id
  FROM event e
...
ALTER FUNCTION "public"."event_ids_within_radius"("center_lat" double precision, "center_lon" double precision, "radius_miles" double precision) OWNER TO "postgres";
...
CREATE SEQUENCE IF NOT EXISTS "public"."app_user_user_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE SEQUENCE IF NOT EXISTS "public"."organizer_organizer_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE "public"."organizer_organizer_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."organizer_organizer_id_seq" OWNED BY "public"."organizer"."organizer_id";
...
CREATE SEQUENCE IF NOT EXISTS "public"."venue_venue_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."organizer" ALTER COLUMN "organizer_id" SET DEFAULT "nextval"('"public"."organizer_organizer_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."event_category"
    ADD CONSTRAINT "event_category_pkey" PRIMARY KEY ("event_id", "category");
...
CREATE INDEX "event_cat_idx" ON "public"."event_category" USING "btree" ("category");



CREATE INDEX "event_search_gin" ON "public"."event" USING "gin" ("search_tsv");
...
CREATE INDEX "event_time_idx" ON "public"."event" USING "btree" ("start_at", "end_at");



CREATE INDEX "venue_location_gix" ON "public"."venue" USING "gist" ("location");



ALTER TABLE ONLY "public"."event_category"
    ADD CONSTRAINT "event_category_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."event"("event_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."event"
    ADD CONSTRAINT "event_organizer_id_fkey" FOREIGN KEY ("organizer_id") REFERENCES "public"."organizer"("organizer_id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."event"
    ADD CONSTRAINT "event_venue_id_fkey" FOREIGN KEY ("venue_id") REFERENCES "public"."venue"("venue_id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."organizer"
    ADD CONSTRAINT "organizer_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."app_user"("user_id") ON DELETE CASCADE;
...
GRANT ALL ON FUNCTION "public"."event_ids_within_radius"("center_lat" double precision, "center_lon" double precision, "radius_miles" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."event_ids_within_radius"("center_lat" double precision, "center_lon" double precision, "radius_miles" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."event_ids_within_radius"("center_lat" double precision, "center_lon" double precision, "radius_miles" double precision) TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."app_user_user_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."app_user_user_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."app_user_user_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."event_category" TO "anon";
GRANT ALL ON TABLE "public"."event_category" TO "authenticated";
GRANT ALL ON TABLE "public"."event_category" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."organizer_organizer_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."organizer_organizer_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."organizer_organizer_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."venue_venue_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."venue_venue_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."venue_venue_id_seq" TO "service_role";
